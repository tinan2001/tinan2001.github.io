...
# Conclusion
Attempts to use OpenStreetMap (OSM) data and land-change centroids to identify areas of land-use change were not successful. This may be due to the high spatial specificity of OSM’s vector data, which limited its compatibility with raster-based change detection. Other approaches could be explored to improve detection accuracy. For example, automated land-use classification methods developed in previous studies have shown strong potential for detecting urban change (Hu & Wang, 2013).

A total of 27 vegetation-to-urban surface hotspots were identified over the study period. The major hotspots were classified as residential neighborhoods and apartment buildings. Residential hotspots were primarily located outside the two-mile radius from the University at Buffalo’s North Campus, suggesting they are oriented toward local residents and reflect the town’s overall population growth, as indicated by U.S. Census data.

In contrast, most apartment hotspots were concentrated within the two-mile buffer zone surrounding the campus (likely serving the student population). The increase in off-campus student housing indicates signs of studentification, particularly in terms of physical land change. Based on findings from other studentification studies, these student-oriented neighborhoods may experience seasonal fluctuations, making areas appearing quiet during academic breaks and significantly busier, with increased traffic and noise, during the academic year.
...
Hu, S., & Wang, L. (2013). Automated urban land-use classification with remote sensing. International Journal of Remote Sensing, 34(3), 790–803. https://doi.org/10.1080/01431161.2012.714510
